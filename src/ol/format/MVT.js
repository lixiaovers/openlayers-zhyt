 ...
 * @property {function} [filter] 自定义要素实例化过滤器,function的参数格式{id:"",geometry:"",layer:{}, properties:{}} added by lipeng 2020.09.16.
 * layers.
 */
...
class MVT extends FeatureFormat {
    ...
    constructor(opt_options) {
        ...
        /**
         * 自定义要素实例化过滤器
         * function的参数格式{id:"",geometry:"",layer:{}, properties:{}}
         * added by lipeng 2020.09.16
         * @private
         * @type {function}
         */
    ...
    readFeatures(source, opt_options) {
        ...
        for (const name in pbfLayers) {
            ...
            for (let i = 0, ii = pbfLayer.length; i < ii; ++i) {
                ...
                //根据过滤器添加要素 modified by lipeng 2020.9.16
                if (!this.filter) {
                    features.push(this.createFeature_(pbf, rawFeature, options));
                } else if (this.filter(rawFeature)) {
                    features.push(this.createFeature_(pbf, rawFeature, options));
                }
            }
        }
